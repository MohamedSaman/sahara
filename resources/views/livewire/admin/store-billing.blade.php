                                ...
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            @elseif ($paymentReceiptImagePreview && $paymentReceiptImagePreview !==
                                            'image')
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex justify-content-between mt-1">
                                                    ...
                                                    <small class="text-success">{{ $initialPaymentAmount ?
                                                            number_format(($initialPaymentAmount / $grandTotal) * 100,
                                                            0) : 0 }}%</small>
                                                    <small class="text-muted">Rs.{{ number_format($grandTotal, 2)
                                                            }}</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card mb-3 border border-info bg-light">
                                        <div class="card-body p-3">
                                            <h6 class="card-title fw-bold mb-3">
                                                ...
                                                <span class="badge bg-info float-end">Rs.{{
                                                        number_format($balanceAmount, 2) }}</span>
                                            </h6>
